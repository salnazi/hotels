						...
						<div class="tab-content">
				                ...
				                <div class="col-md-2">
				                  <div class="form-group">
				                    ...
				                    <div class="form-field">
				                      ...
				                      <input type="text" id="datepicker" class="form-control date" placeholder="Check-in date">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-2">
				                  <div class="form-group">
				                    ...
				                    <div class="form-field">
				                      <i class="icon icon-calendar2"></i>
				                      <input type="text" id="datepicker" class="form-control date" placeholder="Check-out date">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-3">
					        ...
					        <div id="hotel" class="tab-pane fade in active">
							      <form method="POST" class="colorlib-form">
				                    ...
				                    <label for="date">Where:</label>
				                    <div class="form-field">
				                      <input type="text" id="cities" name='cities' class="form-control" placeholder="Enter the City">
				                    </div>
				                  </div>
					              	 </div>
					                <div class="col-md-3">
					                  <div class="form-group">
					                    ...
					                    <div class="form-field">
					                      <i class="icon icon-calendar2"></i>
					                      <input type="text" id="datepicker" name='fromdt' class="form-control date" placeholder="Check-in date">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-3">
					                  <div class="form-group">
					                    ...
					                    <div class="form-field">
					                      <i class="icon icon-calendar2"></i>
					                      <input type="text" id="datepicker" name='todt' class="form-control date" placeholder="Check-out date">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-2">
						   	...
						   	<form method="post" class="colorlib-form">
				              	<div class="row">
				              	 <div class="col-md-4">
				                    ...
				                    <label for="date">Where:</label>
				                    <div class="form-field">
				                      <input type="text" id="cities" class="typeahead" placeholder="Search Location" >
				                    </div>
				                  </div>
				              	 </div>
				                <div class="col-md-3">
